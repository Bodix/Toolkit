...
namespace Dirty.Editor
{
	...
	{
		private static bool viewBigIcons = true;
		private static bool darkPreview = true;

		private static GUIContent iconSelected;
		// private static GUIStyle iconBtnStyle = null;
		...
		private static List<string> iconMissingNames;
		private static GUIStyle iconButtonStyle;
		private static GUIStyle iconPreviewBlack;
		private static GUIStyle iconPreviewWhite;
		...
		{
			// EditorIcons window = CreateWindow<EditorIcons>("Editor Icons");
